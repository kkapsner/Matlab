...
%       does not open a file select GUI but only the stack creation GUI
    ...
    height = 2*padding + (numFiles + 1) * lineHeight + (numFiles + 1 - 1) * innerPadding;
    textWidth = 50;
    selectWidth = 90;
    ...
    for itemIndex = 1:numFiles
        x = padding;
        y = padding + (numFiles + 1 - itemIndex) * (lineHeight + innerPadding);
    ...
    y = padding;
    x = (width - 200) / 3;
    okButton = handle(uicontrol(...
        'Parent', f, ...
        'Style', 'pushbutton', ...
        'String', 'OK', ...
        'Position', [x, y, 100, lineHeight], ...
        'HandleVisibility', 'off', ...
        'Callback', @createStack...
    ));
    x = 100 + 2*(width - 200) / 3;
    cancelButton = handle(uicontrol(...
        'Parent', f, ...
        'Style', 'pushbutton', ...
        'String', 'cancel', ...
        'Position', [x, y, 100, lineHeight], ...
