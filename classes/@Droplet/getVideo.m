function video = getVideo(this, varargin)
    if (numel(this) == 1)
        ...
        p.addOptional('verbose', @islogical);
        ...
        width = max( ...
            floor(this.p(positionFilter, 1) + this.radius(positionFilter) + p.Results.margin(2)) ...
            - ...
        ...
        height = max( ...
            ...
            - ...
            ceil(this.p(positionFilter, 2) - this.radius(positionFilter) - p.Results.margin(1)) ...
        );
